...
import {IdealLabelModule} from "./components/label/label.component";
import {IdealBadge} from "./directives/badge.directive";
import {DiscardChangesDialogComponent} from "./components/discard-changes/discard-changes-dialog.component";
...
@NgModule({
  declarations: [WidgetAvatarComponent, WidgetNamedAvatarComponent, WidgetLabeledInput, StringValueAccessorDirective,
    ...
    PasswordMatcherDirective, IdealInputIdle, EmailValidatorDirective, IdealBadge, DiscardChangesDialogComponent, DocComponent,
  ...
  exports: [WidgetAvatarComponent, WidgetNamedAvatarComponent, WidgetLabeledInput, StringValueAccessorDirective, AvatarChooserComponent,
    ...
    EmailValidatorDirective, IdealLabelModule, IdealBadge, DiscardChangesDialogComponent, DocComponent, DocHeaderComponent,
  ...
  entryComponents: [UploadImageDialogComponent, DiscardChangesDialogComponent]
})
