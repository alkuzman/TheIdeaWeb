...
import {SecurityContext} from "../../../core/authentication/security.context.service";
...
// After the password is entered generate password based key and encrypt all private data from security profile
    ...
    generateZip() {
        ...
        // Create folders
        let protocolFolder = zip.folder("ProtocolKeys");
        let ideasKeyFolder = zip.folder("SavingIdeasKey");
        let encryptionFolder = protocolFolder.folder("EncryptionKeys");
        let signingFolder = protocolFolder.folder("SigningKeys");
