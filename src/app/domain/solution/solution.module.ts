...
@NgModule({
  ...
  declarations: [SolutionQualityDetailsComponent, SolutionQualityDialogComponent,
    SolutionQualityComponent, SolutionFieldsComponent, SolutionFormComponent,
    NewSolutionFormComponent, UpdateSolutionFormComponent],
  exports: [SolutionQualityDetailsComponent, SolutionQualityDialogComponent,
    SolutionQualityComponent, SolutionFieldsComponent, SolutionFormComponent,
    NewSolutionFormComponent, UpdateSolutionFormComponent],
