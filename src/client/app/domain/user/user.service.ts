...
export class UserService {
  ...
  constructor(private http: Http, private jwtAuthenticationService: JwtAuthenticationService, private jwtSecurityContext: JwtSecurityContext, private userObjectService: UserObjectService) {
  }
